  ...
  <v-toolbar fixed app dark>
    ...
    <v-dialog v-model="helpDialog" persistent>
      ...
      <v-card>
        ...
        <v-card-text>Email: help@vdm.com.pk<br>Phone #: (021) 34546491<br>
          ...
          -----------------------------<br>
          Initial Release <br>
          Next Patch on 02-May-2018 -- 12:00PM <br>

          ------------------------------------------------------- <br>
          NOTE: IF YOU EXPERIENCE ANY ERROR PLEASE NOTIFY WITH P.M <br>
          ------------------------------------------------------- <br>
        </v-card-text>
        <v-card-actions>
    ...
    <v-dialog v-model="loading.mainLoading" persistent >
      ...
      <v-card dark>
        ...
        <v-card-text>It will not take more than 30 seconds</v-card-text>
        <v-container>
